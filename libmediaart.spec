...
Source0  : https://download.gnome.org/sources/libmediaart/1.9/libmediaart-1.9.5.tar.xz
...
%prep
%setup -q -n libmediaart-1.9.5
cd %{_builddir}/libmediaart-1.9.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1622762253
...
cp %{_builddir}/libmediaart-1.9.5/COPYING %{buildroot}/usr/share/package-licenses/libmediaart/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/libmediaart-1.9.5/COPYING.LESSER %{buildroot}/usr/share/package-licenses/libmediaart/01a6b4bf79aca9b556822601186afab86e8c4fbf
